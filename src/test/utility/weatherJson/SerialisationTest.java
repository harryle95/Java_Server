...
public class SerialisationTest {
    ...
    void setUp() {
        ...
        stringMap.get("Server1").get("File1").putAll(new HashMap<String, String>() {{
            put("timestamp", "10");
            put("value", "LongString");
        }});
    }

    @Test
    void testSerialising() throws IOException, ClassNotFoundException {
        FileOutputStream fout = new FileOutputStream("src/test/utility/weatherJson" +
                                                     "/resources/testBackUp");
        ObjectOutputStream out = new ObjectOutputStream(fout);
        out.writeObject(stringMap);
        out.close();
        FileInputStream fis = new FileInputStream("src/test/utility/weatherJson" +
                                                  "/resources/testBackUp");
        ObjectInputStream in = new ObjectInputStream(fis);
        Map<String, Map<String, Map<String, String>>> backup = (Map<String,
                Map<String, Map<String, String>>>) in.readObject();
